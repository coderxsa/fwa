...
class VCardBuilder {
    ...
    setFullName(fullName) {
        if (!fullName)
            throw new Error('[n3bu1a] vcard builder need full name');
        this.fullName = fullName;
        return this;
    }
    setOrg(organizationName) {
        if (!organizationName)
            throw new Error("[n3bu1a] vcard builder need organization name");
        this.org = organizationName;
        return this;
    }
    setNumber(number) {
        if (!number)
            throw new Error('[n3bu1a] vcard builder need number');
        this.number = number;
        return this;
    }
    build() {
